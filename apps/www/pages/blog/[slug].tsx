...
import ShareArticleActions from '~/components/layouts/Blog/ShareArticleActions'
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: `/images/blog/${props.blog.image ? props.blog.image : props.blog.thumb}`,
