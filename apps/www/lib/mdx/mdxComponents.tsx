...
import { ImageProps } from 'ui/src/components/Image/Image'

const Tabs = dynamic(() => import('~/components/layouts/Tabs/Tabs'), { ssr: false })
const TabPanel = dynamic(
  () => import('~/components/layouts/Tabs/').then((mod) => ({ default: mod.TabPanel })),
  { ssr: false }
)
const Quote = dynamic(() => import('~/components/layouts/Quote'))
