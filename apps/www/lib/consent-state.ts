    ...
    consentState.categories = [
      {
        ...
        services: [
          {
            id: 'service_core_functionality',
            categorySlug: 'essential-cookies',
            fetchSubServices: async () => [],
            isEssential: true,
            isHidden: false,
            processorId: 'core_functionality',
            subServices: [],
            subServicesLength: 0,
            usesThirdCountry: false,
            version: '1.0.0',
