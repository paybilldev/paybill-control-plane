...
import { pickFeatures, pickFooter, plans } from 'data/plans'
  ...
  return (
    <div className="mx-auto lg:container lg:px-16 xl:px-12 flex flex-col">
      <div className="relative z-10 mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-md grid lg:max-w-none lg:grid-cols-3 xl:grid-cols-3 gap-4 xl:gap-0">
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isTeamPlan && 'border-foreground-muted !border-2 !rounded-xl xl:-my-8',
                  isProPlan && 'xl:border-l-0'
                )}
              >
                <div
                  className={cn(
                    'px-8 xl:px-4 2xl:px-8 pt-6',
                    isTeamPlan ? 'rounded-tr-[9px] rounded-tl-[9px]' : ''
                  )}
                >
