...
import { cn, Button, Panel } from 'ui'
        ...
        <div className="p-4 pb-0 lg:p-8 gap-4">
          ...
          <div className="flex items-center gap-4 mt-4">
            <Button asChild size="tiny" type="default">
              <Link href="/docs/guides/platform/compute-add-ons">Learn about Compute add-ons</Link>
            </Button>
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-4 md:gap-8 mt-4 md:mt-0 border-t">
              <div className="max-w-4xl prose p-4 md:p-8 relative z-10">
                ...
                <p className="text-[13px] text-foreground-lighter">
                  Every project on the Paybill Platform comes with its own dedicated Postgres or
                  Mysql instance. Select the compute size that fits your needs.
                </p>
                <p className="text-[13px] text-foreground-lighter">
                ...
                <p className="text-[13px] text-foreground-lighter">
                  ...
                  or{' '}
                  <Link
                    href="/docs/guides/platform/compute-add-ons"
                    target="_blank"
                    className="transition text-brand hover:text-brand-600"
                  >
                    Compute Add-ons
