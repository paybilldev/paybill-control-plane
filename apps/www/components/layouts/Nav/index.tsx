...
import { AuthenticatedDropdownMenu, useIsLoggedIn, useUser } from 'common'
...
const NavigationMenu = dynamic(() =>
  import('ui/src/components/Shadcn/NavigationMenu').then((mod) => mod.NavigationMenu)
)
const NavigationMenuContent = dynamic(() =>
  import('ui/src/components/Shadcn/NavigationMenu').then((mod) => mod.NavigationMenuContent)
)
const NavigationMenuItem = dynamic(() =>
  import('ui/src/components/Shadcn/NavigationMenu').then((mod) => mod.NavigationMenuItem)
)
const NavigationMenuLink = dynamic(() =>
  import('ui/src/components/Shadcn/NavigationMenu').then((mod) => mod.NavigationMenuLink)
)
const NavigationMenuList = dynamic(() =>
  import('ui/src/components/Shadcn/NavigationMenu').then((mod) => mod.NavigationMenuList)
)
const NavigationMenuTrigger = dynamic(() =>
  import('ui/src/components/Shadcn/NavigationMenu').then((mod) => mod.NavigationMenuTrigger)
)
const ScrollProgress = dynamic(() =>
  import('ui/src/components/ScrollProgress').then((mod) => mod.ScrollProgress)
)
  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'absolute inset-0 h-full w-full bg-background/90 dark:bg-background/95 !bg-transparent dark:!bg-black transition-all'
          )}
        />
        <nav
          className={cn(
        ...
        <ScrollProgress includePaths={['/blog/']} />
      </div>
    </>
  )
}
