...
import { Panel, SectionContainer, SectionHeader, Button, cn } from 'ui'
  ...
  <div id="customers" className="overflow-hidden pb-16 md:pb-24">
    <SectionContainer className="!pb-8 w-full flex gap-4 justify-between flex-col xl:flex-row xl:items-end">
      <SectionHeader
        ...
        paragraph="See how Paybill empowers companies of all sizes to accelerate their growth and streamline their work."
        className="xl:w-1/2"
      />
