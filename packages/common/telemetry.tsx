...
import { TelemetryEventBody, TelemetryIdentifyBody, TelemetryPageBody } from 'platform-api-types'
...
export function handlePageTelemetry(
  ...
  slug?: string,
  ref?: string,
  telemetryDataOverride?: TelemetryPageBody
) {
...
export function sendTelemetryIdentify(API_URL: string, body: TelemetryIdentifyBody) {
  const consent = hasConsented()
